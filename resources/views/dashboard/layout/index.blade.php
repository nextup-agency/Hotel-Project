                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('article.index') }}" aria-expanded="false"><i
                                    class="mdi mdi-blogger"></i><span class="hide-menu">Article</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('requirement.index') }}" aria-expanded="false"><i
                                    class="mdi mdi-contacts"></i><span class="hide-menu">Requirement</span></a>
                        </li>
