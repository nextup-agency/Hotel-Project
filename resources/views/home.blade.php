            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="left-image">
                        <img src="/profile/assets/images/featured.jpg" alt="">
                ...
                <div class="col-lg-3">
                    <div class="info-table">
                        <ul>
                            <li>
                                <img src="/profile/assets/images/info-icon-01.png" alt="" style="max-width: 52px;">
                                <h4>250 m2<br><span>Total Flat Space</span></h4>
                            </li>
                            <li>
                                <img src="/profile/assets/images/info-icon-02.png" alt="" style="max-width: 52px;">
                                <h4>Contract<br><span>Contract Ready</span></h4>
                            </li>
                            <li>
                                <img src="/profile/assets/images/info-icon-03.png" alt="" style="max-width: 52px;">
                                <h4>Payment<br><span>Payment Process</span></h4>
                            </li>
                            <li>
                                <img src="/profile/assets/images/info-icon-04.png" alt="" style="max-width: 52px;">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="video-frame">
                        <img src="/profile/assets/images/video-frame.jpg" alt="">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="appartment" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <img src="/profile/assets/images/deal-01.jpg" alt="">
                                        </div>
                                        <div class="col-lg-3">
                                            ...
                                            <div class="icon-button">
                                                <a href="/profile/property-details.html"><i class="fa fa-calendar"></i>
                                                    Schedule a visit</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="villa" role="tabpanel" aria-labelledby="villa-tab">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <img src="/profile/assets/images/deal-02.jpg" alt="">
                                        </div>
                                        <div class="col-lg-3">
                                ...
                                <div class="tab-pane fade" id="penthouse" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <img src="/profile/assets/images/deal-03.jpg" alt="">
                                        </div>
                                        <div class="col-lg-3">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        <a href="/profile/property-details.html"><img src="/profile/assets/images/property-01.jpg"
                                alt=""></a>
                        <span class="category">Luxury Villa</span>
                        <h6>$2.264.000</h6>
                        <h4><a href="/profile/property-details.html">18 New Street Miami, OR 97219</a></h4>
                        <ul>
                        ...
                        <div class="main-button">
                            <a href="/profile/property-details.html">Schedule a visit</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        <a href="/profile/property-details.html"><img src="/profile/assets/images/property-02.jpg"
                                alt=""></a>
                        <span class="category">Luxury Villa</span>
                        <h6>$1.180.000</h6>
                        <h4><a href="/profile/property-details.html">54 Mid Street Florida, OR 27001</a></h4>
                        <ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        <a href="/profile/property-details.html"><img src="/profile/assets/images/property-03.jpg"
                                alt=""></a>
                        <span class="category">Luxury Villa</span>
                        <h6>$1.460.000</h6>
                        <h4><a href="/profile/property-details.html">26 Old Street Miami, OR 38540</a></h4>
                        <ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        <a href="/profile/property-details.html"><img src="/profile/assets/images/property-04.jpg"
                                alt=""></a>
                        <span class="category">Apartment</span>
                        <h6>$584.500</h6>
                        <h4><a href="/profile/property-details.html">12 New Street Miami, OR 12650</a></h4>
                        <ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        <a href="/profile/property-details.html"><img src="/profile/assets/images/property-05.jpg"
                                alt=""></a>
                        <span class="category">Penthouse</span>
                        <h6>$925.600</h6>
                        <h4><a href="/profile/property-details.html">34 Beach Street Miami, OR 42680</a></h4>
                        <ul>
                            <li>Bedrooms: <span>4</span></li>
                            <li>Bathrooms: <span>4</span></li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        <a href="/profile/property-details.html"><img src="/profile/assets/images/property-06.jpg"
                                alt=""></a>
                        <span class="category">Modern Condo</span>
                        <h6>$450.000</h6>
                        <h4><a href="/profile/property-details.html">22 New Street Portland, OR 16540</a></h4>
                        <ul>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="item phone">
                                <img src="/profile/assets/images/phone-icon.png" alt="" style="max-width: 52px;">
                                <h6>010-020-0340<br><span>Phone Number</span></h6>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="item email">
                                <img src="/profile/assets/images/email-icon.png" alt="" style="max-width: 52px;">
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 col-xl-6 ">
                    <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="collapse"
                        data-bs-target="#chatCollapse" aria-expanded="false" aria-controls="chatCollapse">
                        Open Chat
                    </button>
                    <div class="collapse fixed-chat" id="chatCollapse">
                            ...
                            <div class="card-body" style="position: relative; max-height: 400px; overflow-y: auto;">
                                ...
                                <div class="d-flex flex-row justify-content-start mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="small p-2 ms-3 mb-1 rounded-3 bg-body-tertiary">How are you ...???</p>
                                ...
                                <div class="d-flex flex-row justify-content-start mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="small p-2 ms-3 mb-1 rounded-3 bg-body-tertiary">We will go on Sunday?</p>
                                ...
                                <div class="d-flex flex-row justify-content-end mb-4">
                                    <div>
                                        ...
                                        <p class="small p-2 me-3 mb-1 text-white rounded-3 bg-primary">I will meet you at
                                            Sandon Square sharp at 10 AM</p>
                                        <p class="small p-2 me-3 mb-1 text-white rounded-3 bg-primary">Is that okay?</p>
                                        <p class="small me-3 mb-3 rounded-3 text-muted d-flex justify-content-end">00:09
                                        </p>
                                    </div>
                                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava4-bg.webp"
                                        alt="avatar 1" style="width: 45px; height: auto;">
                                ...
                                <div class="d-flex flex-row justify-content-start mb-4">
                                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3-bg.webp"
                                        alt="avatar 1" style="width: 45px; height: auto;">
                                    <div>
                                        <p class="small p-2 ms-3 mb-1 rounded-3 bg-body-tertiary">Okay I will meet you at
                                            Sandon Square</p>
                                ...
                                <div class="d-flex flex-row justify-content-end mb-4">
                                    <div>
                                        <p class="small p-2 me-3 mb-1 text-white rounded-3 bg-primary">Do you have pictures
                                            of Matley's Marriage?</p>
                                        <p class="small me-3 mb-3 rounded-3 text-muted d-flex justify-content-end">00:11
                                        </p>
                                    </div>
                                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava4-bg.webp"
                                        alt="avatar 1" style="width: 45px; height: auto;">
                                ...
                                <div class="d-flex flex-row justify-content-start mb-4">
                                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3-bg.webp"
                                        alt="avatar 1" style="width: 45px; height: auto;">
                                    <div>
                                        <p class="small p-2 ms-3 mb-1 rounded-3 bg-body-tertiary">Sorry I don't have. I
                                            changed my phone.</p>
                                ...
                                <div class="d-flex flex-row justify-content-end">
                                    <div>
                                        <p class="small p-2 me-3 mb-1 text-white rounded-3 bg-primary">Okay then see you on
                                            Sunday!!</p>
                                        <p class="small me-3 mb-3 rounded-3 text-muted d-flex justify-content-end">00:15
                                        </p>
                                    </div>
                                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava4-bg.webp"
                                        alt="avatar 1" style="width: 45px; height: auto;">
