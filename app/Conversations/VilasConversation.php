...
class VilasConversation extends Conversation
{
    ...
    public function askVilaType()
    {
        $question = Question::create('Jenis vila apa yang Anda cari?')
            ...
            ->callbackId('ask_vila_type') // Menggunakan callback ID yang berbeda
            ->addButtons([
    ...
    public function retrieveVilaInformation()
    {
        ...
        $villas = [
            ...
            'Bedroom Type I & O' => [
                ['name' => 'Bedroom Type I & O', 'price' => 'Rp 2.400.000/malam', 'images' => [Storage::url('villas/bedroom_type_i1.jpg'), Storage::url('villas/bedroom_type_i2.jpg')]],
            ],
            'Bedroom Type P' => [
